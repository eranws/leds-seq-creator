...
light_one(
    3, [cup_cake3, paper2, bottle5, cabbage1], light_yellow_string, orange_strip, 15
)
...
blink_and_snake_group(
    1, [group2, group3], turquoise_string[0], indigo[0], turquoise_string[0], indigo[0]
)
blink_and_snake_group(
    2,
    [group4, group5],
    purple_string[0],
    light_purple_strip[0],
    purple_string[0],
    blue[0],
)
