...
from infra.length import soft
from infra.timing import beats
from led_objects.instances import *
from led_objects.groups import group1, group3, group4, group6, group7, group8
...
episode_length = 8
background_elements = (
    [sheep, cup_cake4] + cabbages + brains + donuts + rugs + flowers + bottles
)
...
grrrrr(46, 58)
pattern(
    46, 50, [lifas1, lifas5, sticks3, sticks7, sticks8], [0.61, 9 / 12], double=True
)
pattern(
    50, 54, [lifas1, lifas5, sticks3, sticks7, sticks8], [9 / 12, 0.61], double=True
)
...
pattern(
    54, 58, [lifas1, lifas5, sticks3, sticks7, sticks8], [0.61, 9 / 12], double=True
)
