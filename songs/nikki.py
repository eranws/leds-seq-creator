...
cycle(4)
cycle_beats(0, 0.66)
elements([lifas1.stand(5), lifas5.stand(5)])
...
cycle(4)
cycle_beats(0, 0.66)
elements(cabbage1, rug4)
color.gradient(0.6, 1.0)
effect.saw_tooth(1.0)

cycle_beats(1, 1.66)
elements(cabbage5, rug6, cup_cake4)
color.gradient(0.4, 0.8)
effect.saw_tooth(1.0)

cycle_beats(1.33, 2.0)
elements(cup_cake3, cabbage6)
color.gradient(0.4, 0.8)
effect.saw_tooth(1.0)
