...
group2 = [paper2]
group3 = [cup_cake3, donut3, sticks3]
group4 = [lifas4, rug4, bottle4, cup_cake4]
group5 = [paper5, lifas5, bottle5, cabbage5]
group6 = [flower6, cabbage6, rug6]
group7 = [sticks7, brain7, star7]
group8 = [sticks8, gloves8]
